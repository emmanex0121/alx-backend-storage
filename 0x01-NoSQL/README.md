...
```
phoenix@phoenix-PC:~/0x01$ cat 0-list_databases | mongo
...
bye
phoenix@phoenix-PC:~/0x01$
phoenix@phoenix-PC:~/0x01$ cat 1-use_or_create_database | mongo
MongoDB shell version v3.6.3
connecting to: mongodb://127.0.0.1:27017
MongoDB server version: 3.6.3
...
```
phoenix@phoenix-PC:~/0x01$ cat 2-insert | mongo my_db
MongoDB shell version v3.6.3
...
```
phoenix@phoenix-PC:~/0x01$ cat 3-all | mongo my_db
MongoDB shell version v3.6.3
connecting to: mongodb://127.0.0.1:27017/my_db
MongoDB server version: 3.6.3
...
```
phoenix@phoenix-PC:~/0x01$ cat 4-match | mongo my_db
MongoDB shell version v3.6.3
connecting to: mongodb://127.0.0.1:27017/my_db
MongoDB server version: 3.6.3
{ "_id" : ObjectId("5a8fad532b69437b63252406"), "name" : "Holberton school" }
...
```
phoenix@phoenix-PC:~/0x01$ cat 5-count | mongo my_db
MongoDB shell version v3.6.3
connecting to: mongodb://127.0.0.1:27017/my_db
MongoDB server version: 3.6.3
1
...
```
phoenix@phoenix-PC:~/0x01$ cat 6-update | mongo my_db
MongoDB shell version v3.6.3
connecting to: mongodb://127.0.0.1:27017/my_db
MongoDB server version: 3.6.3
...
```
phoenix@phoenix-PC:~/0x01$ cat 7-delete | mongo my_db
MongoDB shell version v3.6.3
connecting to: mongodb://127.0.0.1:27017/my_db
MongoDB server version: 3.6.3
...
```
phoenix@phoenix-PC:~/0x01$ cat 8-main.py
#!/usr/bin/env python3
""" 8-main """
...
phoenix@phoenix-PC:~/0x01$
phoenix@phoenix-PC:~/0x01$ ./8-main.py
...
```
phoenix@phoenix-PC:~/0x01$ cat 9-main.py
#!/usr/bin/env python3
""" 9-main """
from pymongo import MongoClient
list_all = __import__('8-all').list_all
...
phoenix@phoenix-PC:~/0x01$
phoenix@phoenix-PC:~/0x01$ ./9-main.py
...
```
phoenix@phoenix-PC:~/0x01$ cat 10-main.py
#!/usr/bin/env python3
""" 10-main """
from pymongo import MongoClient
list_all = __import__('8-all').list_all
...
phoenix@phoenix-PC:~/0x01$
phoenix@phoenix-PC:~/0x01$ ./10-main.py
...
```
phoenix@phoenix-PC:~/0x01$ cat 11-main.py
#!/usr/bin/env python3
""" 11-main """
from pymongo import MongoClient
list_all = __import__('8-all').list_all
...
phoenix@phoenix-PC:~/0x01$
phoenix@phoenix-PC:~/0x01$ ./11-main.py
...
```
phoenix@phoenix-PC:~/0x01$ curl -o dump.zip -s "https://s3.amazonaws.com/intranet-projects-files/holbertonschool-webstack/411/dump.zip"
phoenix@phoenix-PC:~/0x01$
phoenix@phoenix-PC:~/0x01$ unzip dump.zip
Archive:  dump.zip
   creating: dump/
   creating: dump/logs/
...
phoenix@phoenix-PC:~/0x01$
phoenix@phoenix-PC:~/0x01$ mongorestore dump
...
phoenix@phoenix-PC:~/0x01$
phoenix@phoenix-PC:~/0x01$ ./12-log_stats.py
94778 logs
Methods:
    method GET: 93842
    method POST: 229
